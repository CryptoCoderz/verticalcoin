...
void Shutdown() {
    ...
    // TODO: https://github.com/verticalcoin/verticalcoin/issues/182
...
std::string LicenseInfo() {
    const std::string URL_SOURCE_CODE = "<https://github.com/verticalcoin/verticalcoin>";
    const std::string URL_WEBSITE = "<http://verticalcoin.io/>";
...
void InitLogging() {
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Verticalcoin version %s\n", FormatFullVersion());
}
        ...
        do {
            try {
                ...
                if (!mapBlockIndex.empty() && mapBlockIndex.count(chainparams.GetConsensus().hashGenesisBlock) == 0) {
                    LogPrintf("Hash: %s", chainparams.GetConsensus().hashGenesisBlock.ToString());
